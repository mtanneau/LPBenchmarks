...
julia --sysimage=$LPBDIR/JuliaLP.so --project=$LPBDIR $LPBDIR/src/LP/glpk.jl $LPBDIR/dat/plato/${inst[${SLURM_ARRAY_TASK_ID}-1]} > $LPBDIR/logs/mittelman/glpk/${inst[${SLURM_ARRAY_TASK_ID}-1]}.glpk 2>&1